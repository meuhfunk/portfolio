...
<head>
    ...
    <meta name="description" content="Portfolio - Nicolas LEYMARIE ">
  	<title><?= $title; ?></title>



<!-- Open Graph data -->
    <meta property="og:title" content="Nicolas LEYMARIE - Portfolio"/>
    <meta property="og:type" content="website"/>
    <meta property="og:description" content="Portfolio - Nicolas LEYMARIE "/>
    ...
    <div id="header-perso">
        <div class="top-header">
          <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
            <div class="container">
              <a class="av-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="index.php#contact"><i class="fa fa-suitcase"></i> Besoin de mes services ?</a>
              ...
              <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item mx-0 mx-lg-1">
                    <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="public/img/cv/C.V 2018 informatique.pdf"><i class="fa fa-download"></i> Télécharger CV</a>
                  </li>
                </ul>
              </div>
            </div>
		      	...
		      	<div class="row">
		        	<div class="col-lg-10 col-md-10 mx-auto text-center">
		          		<div class="site-heading">
		            		<h1><img src="<?= PUBLICS ;?>img/banner/dev-indep.png" alt="Nicolas Leymarie" width="250px"><br>
		            		<?=$heading?></h1>
    ...
    <footer class="py-2 bg-dark">
      <div class="row justify content center">
        <div class="col-sm-12">
          ...
          <span class="m-0 text-center text-white"> Copyright &copy; Nicolas LEYMARIE 2018</span></p>

          <div class="justify content center">
            <div class="fb-like" data-href="http://nicolas-leymarie.fr" data-layout="button" data-action="like" data-size="small" data-show-faces="false" data-share="true"></div>
          </div>
...
<!-- Script -->
  <script src="<?= PUBLICS ;?>js/slider.js" type="text/javascript"></script>
